...
let animalArray = ["fish", "cat", "bird", "dog", "alligator"];
...
console.log("the last animal in the array is: ", lastElement);
...
favFoods.push("Cake");
console.log("Foods are now:", favFoods);
...
console.log("the food are now", favFoods);
// Example: Add an animal to the beginning using Array.unshift
animalArray.unshift("walrus");
console.log(`Added an animal to beginning: ${animalArray}`);

// 4.c. TODO: Add a food at the beginning of the array & log the array
favFoods.unshift("Steam Rolls");
console.log(`Added food to the beginning: ${favFoods}`);
